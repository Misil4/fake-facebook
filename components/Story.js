...
top: 130px;
left: 0px;
border: ${(props => props.profile ? '1px solid #DDDD0D' : 0)};
            ...
            <Container>
              <PersonalCard as={Animated.View} style={{
                  ...
                  style={{
                      ...
                      borderRadius: Animations.imageRdius,
                ...
                <PersonalCardIcon as={Animated.View} style={{transform: [{scale: Animations.iconScale}],
